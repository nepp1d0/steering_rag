...
Usage:
    python -m src.experiments.probe_direction_identification --automated
    python -m src.experiments.probe_direction_identification --automated --force-recompute
    python -m src.experiments.probe_direction_identification \
