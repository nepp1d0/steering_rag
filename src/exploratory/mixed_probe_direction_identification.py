...
Usage:
    python src/exploratory/mixed_probe_direction_identification.py --automated
    python src/exploratory/mixed_probe_direction_identification.py --automated --force-recompute
    python src/exploratory/mixed_probe_direction_identification.py \
...
from mixed_direction_identification import (
    COMBOS,
    DATASETS,
    MIX_SEED,
    POSITIONS,
...
from probe_direction_identification import (
    fit_probe_direction,
