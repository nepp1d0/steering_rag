...
Usage:
    python src/exploratory/mixed_directions_direction_analysis_heatmap.py
    python src/exploratory/mixed_directions_direction_analysis_heatmap.py --models google__gemma-3-4b-it
"""
...
from utils import REPO_ROOT, RESULTS_DIR, load_normalized, logger, setup_logging
