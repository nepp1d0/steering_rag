...
Usage:
    python src/exploratory/ICLR_paper_retrieval_evaluation.py --automated
    python src/exploratory/ICLR_paper_retrieval_evaluation.py --automated --force-recompute
    python src/exploratory/ICLR_paper_retrieval_evaluation.py \
...
def discover_eval_seeds(dataset: str) -> List[int]:
    ...
    from utils import NORMALIZED_DIR
